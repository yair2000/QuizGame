...
// We are using Firebase database, which is a NoSQL database and it doesn't support multiple query condition
...
public class QuestionScore
{
    ...
    public String getQuestion_Score(){return Question_Score;}

    public void setQuestion_Score(String question_Score){Question_Score = question_Score;}
